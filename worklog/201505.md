...
1. 读 [Core Data Tutorial for iOS: Getting Started](http://www.raywenderlich.com/934/core-data-tutorial-for-ios-getting-started)，照示例写代码，了解用法
  ...
  - 读写数据
  - TableView 中显示
2. 读 [Core Data Tutorial for iOS: How To Use NSFetchedResultsController](http://www.raywenderlich.com/999/core-data-tutorial-for-ios-how-to-use-nsfetchedresultscontroller) 了解如何使用 NSFetchedResultsController
