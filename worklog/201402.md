...
1.  读 *The Definitive Guide to ImageMagick* 找畸变矫正方法
...
1.  提取输出文本中的percentile

    -   实验sed, awk等工具

    -   还要了解正则表达式的写法

2.  写脚本用gphoto2采集照片→histogram分析→调整拍摄参数直到曝光符合条件
...
1.  寻找过曝/不过曝边界在数值上的体现（猜测histogram能区分）
...
3.  全图处理：histogram matching, white balance
...
2.  写 [拍照脚本](https://github.com/edwardtoday/LED-Calibration/blob/master/src/captureN.py)
...
3.  读 *The Definitive Guide to ImageMagick*
