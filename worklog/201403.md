...
3.  修正SkyEye Server中的服务逻辑，以符合通信流程
...
1.  修正SkyEye Server中的服务逻辑，以符合通信流程
...
2.  实现脚本拍照前在第二块屏幕显示纯色 White, R, G, B
...
1.  安装并调试SkyEye Server

2.  控制第二块屏幕（用于镜像）的显示内容
...
1.  编译安装 OpenCV for Python 3.3

2.  安装并调试SkyEye Server

3.  控制第二块屏幕（用于镜像）的显示内容
...
1.  读 [Colour Space Conversion](https://github.com/edwardtoday/LED-Calibration/blob/master/ref/coloureq.pdf)
